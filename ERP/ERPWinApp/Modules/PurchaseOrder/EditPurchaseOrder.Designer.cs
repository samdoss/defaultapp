namespace ERPWinApp
{
    partial class EditPurchaseOrderProduct
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.lblEditPurchaseOrderProd = new System.Windows.Forms.Label();
			...
			this.tableLayoutPanel1.Controls.Add(this.lblEditPurchaseOrderProd, 0, 0);
			...
			// 
			// lblEditPurchaseOrderProd
			// 
			this.lblEditPurchaseOrderProd.AutoSize = true;
			this.lblEditPurchaseOrderProd.Location = new System.Drawing.Point(6, 6);
			this.lblEditPurchaseOrderProd.Margin = new System.Windows.Forms.Padding(6);
			this.lblEditPurchaseOrderProd.Name = "lblEditPurchaseOrderProd";
			this.lblEditPurchaseOrderProd.Size = new System.Drawing.Size(95, 18);
			this.lblEditPurchaseOrderProd.TabIndex = 0;
			this.lblEditPurchaseOrderProd.Text = "Edit PurchaseOrder Product";
			// 
			// txtProduct
			// 
			...
			this.Name = "EditPurchaseOrderProduct";
			this.Text = "Edit PurchaseOrder Product";
        ...
        private System.Windows.Forms.Label lblEditPurchaseOrderProd;
