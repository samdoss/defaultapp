namespace ERPWinApp
{
    partial class EditEstimateProduct
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.lblEditEstimateProd = new System.Windows.Forms.Label();
			...
			this.tableLayoutPanel1.Controls.Add(this.lblEditEstimateProd, 0, 0);
			...
			// lblEditEstimateProd
			// 
			this.lblEditEstimateProd.AutoSize = true;
			this.lblEditEstimateProd.Location = new System.Drawing.Point(6, 6);
			this.lblEditEstimateProd.Margin = new System.Windows.Forms.Padding(6);
			this.lblEditEstimateProd.Name = "lblEditEstimateProd";
			this.lblEditEstimateProd.Size = new System.Drawing.Size(95, 18);
			this.lblEditEstimateProd.TabIndex = 0;
			this.lblEditEstimateProd.Text = "Edit Estimate Product";
			// 
			// txtProduct
			// 
			...
			this.Name = "EditEstimateProduct";
			this.Text = "Edit Estimate Product";
        ...
        private System.Windows.Forms.Label lblEditEstimateProd;
