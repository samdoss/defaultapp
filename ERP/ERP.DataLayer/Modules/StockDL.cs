...
namespace ERP.DataLayer
{
    public class StockDL
    {
        ...
        public TransactionResult Commit()
        {
            ...
            Database db = CustomDatabaseFactory.CreateDatabase(_myConnection.DatabaseName);
        ...
        public int GetStockID(int materialID)
        {
            int i;
            ...
            try
            {
                ...
                System.Data.Common.DbCommand dbCommand = db.GetStoredProcCommand("spGetStockByMaterialID");
                 ...
                 using (SqlDataReader dataReader = ((RefCountingDataReader)db.ExecuteReader(dbCommand)).InnerReader as SqlDataReader)
			    {
				    if (dataReader.HasRows)
				    {
                        ...
                        {
                            i = Common.CheckIntNull(dataReader.GetInt32(dataReader.GetOrdinal("AvailableCount")));
                        }
            ...
            {
                ErrorLog.LogErrorMessageToDB("", "StockDL.cs", "GetStockID", exception1.Message.ToString());
            }
            return i;
        }
        ...
        public System.Data.DataSet GetStockList()
        {
            ...
            try
            {
                Database database = CustomDatabaseFactory.CreateDatabase(_myConnection.DatabaseName);
                dataSet = database.ExecuteDataSet(database.GetStoredProcCommand("spGetStockList"));
            }
            catch (System.Exception exception1)
            {
                ErrorLog.LogErrorMessageToDB("", "StockDL.cs", "GetStockList", exception1.Message.ToString());
                throw;
            }
            return dataSet;
        }
